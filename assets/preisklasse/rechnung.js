...
function ergebnis(preisklasse) {
    ...
    if(preisklasse == 1) {
        ...
        ergebnisText.innerHTML = "<p><span style='background-color: #2b2301; color: #fff; display: inline-block; padding: 3px 10px; font-weight: bold; border-radius: 5px;'>Preisklasse 7</span>&nbsp;</p> <p>Dieser Bahnhof bzw. Bahnhaltepunkt f&auml;llt unter die niedrigste Preisklasse (oft auch als 'Landhalte' bezeichnet). Diese Bahnh&ouml;fe haben die geringste Zahl an Reisenden und meist nur die erforderlichsten Ausstattungen die es ben&ouml;tigt. Wegen der geringen Nutzung ist es nicht erforderlich, diesen Bahnhaltepunkt barrierefrei auszubauen.<br />Quelle: <a href='https://de.wikipedia.org/wiki/Preisklasse' target='_blank'>Wikipedia</a>&nbsp;</p>";
    } else {
